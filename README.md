...
## The License
DropletSponsor and all "Droplet" plugins for the Spout platform are licensed under the [MIT License][License].

Copyright (c) 2012, Spout LLC <<http://www.spout.org/>>  

## Getting the Source
The latest and greatest source can be found here on [GitHub][Source].  
Download the latest builds from our [build server][Builds]. [![Build Status](http://build.spout.org/job/DropletSponsor/badge/icon)][Builds]
...
[Source]: https://github.com/Droplets/DropletSponsor
[Builds]: http://build.spout.org/job/DropletSponsor
